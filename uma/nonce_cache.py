...
class INonceCache(ABC):
    @abstractmethod
    def check_and_save_nonce(self, nonce: str, timestamp: int) -> None:
        """
        ...
        Args:
            ...
            timestamp: timestamp corresponding to the nonce in seconds since epoch.
        """
    ...
    def purge_nonces_older_than(self, timestamp: int) -> None:
        ...
        Args:
            timestamp: the timestamp before which nonces should be removed in seconds since epoch.
        """
...
class InMemoryNonceCache(INonceCache):
    ...
    def __init__(self, oldest_valid_timestamp: int) -> None:
